...
<!--
**autografik/autografik** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
-->
### Hello World ?
I am a software engineer from Poland. Working on multiple frontend and backend project using C#, Python, different databases, Java, React and similar.
<!--                       ----- sprawdzi jak dodawać odpowiednie linki określające znaywane technologie -----
